        ...
        <body id="top">
            ...
            <main>
                ...
                <html>
                    ...
                    <body>
                        <c:set var="previousStudentName" value="" />
                        <c:set var="statuses" value="" />
                        <h2 style="color: orange">Attendance Status</h2>
                        <table class="styled-table">
                            ...
                            <tbody>
                                <c:forEach var="o" items="${lista}">
                                    <c:if test="${not empty previousStudentName && !previousStudentName.equals(o.student.name)}">
                                        <tr>
                                            <td>${previousStudentName}</td>
                                            <td style="margin-left:">${statuses}</td>
                                        </tr>
                                        <c:set var="statuses" value="" />
                                    </c:if>
                                    <c:if test="${empty previousStudentName || !previousStudentName.equals(o.student.name)}">
                                        <c:set var="previousStudentName" value="${o.student.name}" />
                                    </c:if>
                                    <c:set var="statuses" value="${statuses}${o.status eq true ? 'o' : 'x'}" />
                                </c:forEach>
